 ...
 * @LastEditTime: 2021-04-24 23:33:43
 * @LastEditors: 阮志雄
 * @Description: 文章相关逻辑
...
class ArticleController {
    async articleCraete(ctx) {
        ...
        let { title, detail, content } = ctx.request.body,
            ...
            id = utils.uuid(),
            author = 'rzx';
        let data = await ArticleService.Index([title, md.render(content), create_time, id, 1, 'Javascript,Vue', md.render(detail), update_time, '/article/' + id, author])
